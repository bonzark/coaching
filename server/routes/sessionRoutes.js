...
const { validateSessionData, validateGetSessionDate } = require('../middlewares/validation');
...
router.put('/:sessionId/update', validateSessionData, sessionController.updateSession);

router.delete('/:sessionId/delete', sessionController.deleteSession);

router.get('/', sessionController.getAllSessions);
router.get('/scheduled_events_calendly', sessionController.scheduledEventsCalendly);
...
router.get('/booked/user/:userId', sessionController.getAllBookedSessionsByUserId);
...
router.get('/user/:userId', sessionController.bookGroupSession);
